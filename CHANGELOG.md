...
- Upgrade transitive `h2` from 0.4.11 to 0.4.16 (`RUSTSEC-2026-0258`).

### Changed

- **Breaking:** `MetricsCollector::get_step_metrics` now takes
  `(scenario_id, step_id)`. Step IDs are scoped per scenario; the previous
